...
The Enterprise deployment boundary — whether Crawldad can run as an operator-managed dedicated instance inside a customer's perimeter — is an open product question tracked in **issue #49**; the App-Gateway-for-long-sync variant would live there.
