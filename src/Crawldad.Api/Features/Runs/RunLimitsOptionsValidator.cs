...
/// a run that can never be admitted. Registered with <c>ValidateOnStart</c>, mirroring <see cref="Crawldad.Api.Infrastructure.Security.TenantRegistry"/>'s boot validation of the per-tenant overrides.</summary>
