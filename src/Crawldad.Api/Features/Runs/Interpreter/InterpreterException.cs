...
internal static class InterpreterErrorCodes
{
    ...
    /// <summary>A <c>download.to</c>'s <c>kind</c> has no registered <see cref="Crawldad.Api.Infrastructure.Storage.IDownloadSink"/>.</summary>
    ...
    /// <see cref="Crawldad.Api.Infrastructure.Storage.IDownloadSink"/> — the capture analogue of <see cref="UnknownDownloadSink"/>.</summary>
    ...
    /// <summary>Run-time: the <c>secretRef</c>'s vault kind has no registered <see cref="Crawldad.Api.Infrastructure.Security.ISecretStore"/> adapter.</summary>
