...
/// <see cref="MaxConcurrentRunsPerTenant"/> is the admission cap <see cref="RunAdmissionGate"/> enforces (per-tenant override via <see cref="Crawldad.Web.Infrastructure.Security.TenantDescriptor.MaxConcurrentRuns"/>).</summary>
public sealed class RunLimitsOptions
{
    ...
    /// (<see cref="Crawldad.Web.Infrastructure.Security.TenantDescriptor.MaxQueueDepth"/>) takes precedence. At this
