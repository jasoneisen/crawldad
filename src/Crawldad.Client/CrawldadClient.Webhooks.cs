...
/// <summary>Webhook-endpoint surface: register (or replace), list, and unregister. The signing secret is write-only —
/// sent on register, never returned by any endpoint.</summary>
