...
internal sealed class FakeTenantRegistryStore : ITenantRegistryStore
{
    ...
    public Task<KeyRevokeOutcome> RevokeKeyGuardedAsync(string tenantId, Guid keyId, string presentedKeyHash, bool allowLastActive, DateTimeOffset now, CancellationToken ct) => throw new NotSupportedException();
