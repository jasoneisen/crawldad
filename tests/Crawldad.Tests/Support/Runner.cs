...
internal static class Runner
{
    ...
    public static async Task<(RunOutcome Outcome, FakeBrowserBackend Backend)> RunWithFakeAsync(string payloadJson, string inputsJson = FakeInputs)
    {
        ...
        var interpreter = new RunInterpreter(payloadDoc.RootElement.Clone(), input, new SingleBackendRegistry("fake", backend), new FakeClock());
